$(document).ready(function(){
    ...
    $('#submit-code').click((event) => {
        ...
        url = "https://codeforces.com/api/%7BmethodName%7D:3000/submissions/?base64_encoded=false&wait=true";
        body = {
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.ajax({
                    type: 'GET',
                    url: "https://codeforces.com:3000/submissions/"+data.token+"?base64_encoded=false",
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    success: function(data){
